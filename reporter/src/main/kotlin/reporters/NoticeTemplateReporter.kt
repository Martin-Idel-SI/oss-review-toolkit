...
class NoticeTemplateReporter : Reporter {
    companion object {
        ...
        private const val NOTICE_DEFAULT_TEMPLATE = "default"
    }

    override val reporterName = "NoticeTemplate"

    private val templateGenerator = FreemarkerTemplateGenerator(NOTICE_FILE_PREFIX, NOTICE_DEFAULT_TEMPLATE)

    override fun generateReport(input: ReporterInput, outputDir: File, options: Map<String, String>): List<File> {
        return templateGenerator.generateTemplate(input, outputDir, options)
    }
}
